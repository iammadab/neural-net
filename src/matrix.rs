...
impl Matrix {
    ...
    fn with_value(row: usize, column: usize, value: i8) -> Self {
...
mod test {
    ...
    fn zero_matrix() {
        ...
        assert_eq!(mat.values, Vec::<Vec<i8>>::new());
